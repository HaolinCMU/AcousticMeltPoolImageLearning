...
PHOTO_SYNC_THRSLD = 0.05 # Default: 0.05. Can be 0.1 for tighter partitioning. 
...
AUDIO_CLIP_LENGTH_DP = 160 # Default: 160. 
AUDIO_CLIP_STRIDE_DP = 80 # Default: 80. 
